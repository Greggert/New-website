...
var resume = "https://drive.google.com/uc?export=download&id=1zXOME-xAwBxZNMs2C4iUIDcWy9VvELPU";
...
"<br>",
  ...
  "Languages",
	"Intermediate:	Python, HTML, CSS/SCSS, JavaScript, C++, Java, Object Oriented Programming",
	"Basic:	T-SQL, MySQL, XML, JSON, Typescript, C#",
	"<br>",
  "<br>",
	"Tools",
	"Intermediate: Oracle VirtualBox, VMware, Atom, Cisco Packet Tracer, Wireshark, Bootstrap, PowerShell, Notepad++", 
	"Basic:	Git, Apache Maven, MobaXterm, MySQL Workbench",
	"<br>",
  "<br>",
	"OS",
  ...
  "<br>",
	"IDE's",
	"Intermediate: VS Code, CLion, Visual Studio, IntelliJ, PyCharm",
